...
<body>
    ...
    <form method="post" action="login.php">
        ...
        <input type="submit" value="進入" class="btn btn-info">
        <input type="button" value="註冊" class="btn btn-info" onclick="location.href='register.html'" >
    </form>
